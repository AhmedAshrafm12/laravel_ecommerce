...
Route::group(['middleware' => ['auth','isAdmin']], function () {
    ...
    Route::put('/order/{order}/update', [orderController::class , "update"]);
    Route::get('/user', [dashboardContrller::class , "index"]);
    Route::get('/user/{user}', [dashboardContrller::class , "show"]);
